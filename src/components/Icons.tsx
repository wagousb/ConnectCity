...
const applyBaseClasses = (props: React.SVGProps<SVGSVGElement>) => {
    const { className, ...rest } = props;
    const newClassName = ['shrink-0', className].filter(Boolean).join(' ');
    return { className: newClassName, ...rest };
};

export const HomeIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...applyBaseClasses(props)}>
...
export const BookmarkIconSolid = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...applyBaseClasses(props)}>
        <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />
    </svg>
);
