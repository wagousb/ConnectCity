          ...
          <div key={user.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 rounded-lg border border-slate-200">
            ...
            <div className="flex items-center space-x-4 flex-shrink-0">
              ...
              >
                ...
                <option value="prefeito">Prefeito<dyad-problem-report summary="1 problems">
<problem file="src/pages/ModerationPage.tsx" line="3" column="29" code="6196">'Profile' is declared but never used.</problem>
</dyad-problem-report>Claro, vou remover a importação não utilizada de `Profile` em `src/pages/ModerationPage.tsx`.

<dyad-write path="src/pages/ModerationPage.tsx" description="Removendo a importação não utilizada de Profile.">
import React, { useState, useEffect, useCallback } from 'react';
import { supabase } from '@/integrations/supabase/client';
import type { User, Report } from '@/types';
import { ShieldCheckIcon, FileTextIcon } from '@/components/Icons';
