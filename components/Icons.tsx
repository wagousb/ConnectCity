...
export const UsersIcon: React.FC<IconProps> = ({ className }) => (
    <svg 
        ...
        className={className}
    >
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 17.25c-2.39 2.39-6.284 2.39-8.674 0l-4.326-4.326a fırsat.75.75 0 0 1 0-1.06l4.326-4.326c2.39-2.39 6.284-2.39 8.674 0l4.326 4.326a.75.75 0 0 1 0 1.06l-4.326 4.326Z" />
...
export const MessageCircleIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a5.969 5.969 0 0 1-.474-.065 4.48 4.48 0 0 0 .978-2.025c.09-.455.09-.934.09-1.425v-2.134c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z" />
  </svg>
);
...
export const BookmarkIconSolid: React.FC<IconProps> = ({ className }) => (
